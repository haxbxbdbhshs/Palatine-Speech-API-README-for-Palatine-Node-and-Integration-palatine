...
Нода поддерживает **интеллектуальный пересказ аудиофайлов** через Palatine Speech API.
...
Произвольная текстовая инструкция
